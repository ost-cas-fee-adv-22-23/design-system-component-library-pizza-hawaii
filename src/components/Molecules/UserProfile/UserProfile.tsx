...
export const UserProfile: FC<TUserProfile> = ({ size = 'M', border, profileLink, userName, avatar }) => {
		...
		if (size !== 'XL') {
			return (
				<div className={[...baseStyle, 'overflow-hidden', sizeMap[size]].join(' ')}>
					<a href={profileLink} className="transition duration-300 ease-in-out hover:scale-110">
