...
export const Switch: FC<BaseProps> = ({ options, value, name, onChange }) => {
	...
	const labelStyles =
		'block hover:cursor-pointer bg-slate-200 first-of-type:rounded-tl-md first-of-type:rounded-bl-md last:rounded-tr-md last:rounded-br-md text-slate-600 text-base font-semibold text-center py-2 px-4 border-slate-600 transition-all ease-in duration-150 ';
